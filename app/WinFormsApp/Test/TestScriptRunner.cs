...
internal static class TestScriptRunner
{
    public static async Task RunAsync()
    {
        ...
        var controller = new global::InputController();
        var parser = new global::ScriptParser();
        var engine = new global::ExecutionEngine(controller);
